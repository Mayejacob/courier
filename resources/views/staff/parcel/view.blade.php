...
<div class="col-12">
    ...
    <div class="invoice p-3 mb-3">
      ...
      <div class="row no-print">
        <div class="col-12">
          <a href="{{ route('staff.parcel')}} " class="btn btn-secondary"> Back</a>
          <a href="{{ route('staff.parcel.edit',$parcel->id)}} " class="btn btn-primary float-right"><i class="far fa-edit"></i> Update Status
          </a>
